...
<form method="post" >
 <div class="container" style="min-width:30em;max-width:50em;">
    <?php 
    if(isset($_GET["id"])){
      $id = $_GET["id"];
      ...
      if($row = mysqli_fetch_array($query)){
        ...
        <div class="card">
            <div class="logo">
                <span class="circle circle4" style = "">
                <img src = "../assets/img/'.$imagename.'" style = "width:80px;height:80px;border-radius:50%;"/>
                </span>
            </div>
            <div class="glass"></div>
            <div class="content">
                <span class="title">'.$name.'</span>
                <span class="text">Date Added: '.$date.'</br>
                Stocks: '.$stocks.'</br> 
                Sold: '.$sold.'</br> 
                <span style = "text-align:center;font-weight:bolder;background-color:transparent;">Price: '.$price.'</span>
                </span>
            </div>
            <div class="bottom">
                ...
                <div class="view-more">
                    <button class="view-more-button">BroCode</button>
    ...
    ?>
    <!--  -->
    <button class="btn btn-dark" name="back" id = "back" >Back</button>
  </div>
</form>
